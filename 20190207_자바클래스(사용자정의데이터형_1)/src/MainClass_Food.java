...
public class MainClass_Food {
	...
	public static void main(String[] args)throws Exception {
		...
		for(CategoryData c:cate)
		{
			...
			System.out.println("부연:"+c.subject);
			System.out.println("====================");
		}
	...
	static FoodData [] foodDetail(int index, String link)
	throws Exception
	{
		FoodData[] fd=new FoodData[index];
		/*
		 * System.out.println("갯수="+index); System.out.println("index="+index);
		 */
		...
		{
			System.out.println("업체명:"+title.get(i).text());
